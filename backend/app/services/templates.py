...
def mrel_eligibility(
    ...
    return Workflow(
        ...
        nodes=[
            ...
            _node("n5", "rules_threshold", "rules", "Rules Threshold", 920, 80),
            _node("n6", "ai_confidence_filter", "rules", "AI Confidence Filter", 1140, 80),
            _node("n7", "human_review", "logic", "Human Review", 1360, 80),
            _node("n8", "decision_output", "output", "Decision Output", 1580, 80),
        ],
        edges=[
